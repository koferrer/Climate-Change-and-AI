...
data<-read.csv("/Users/Koferrer/Documents/GitHub/Climate-Change-and-AI/Climate-Change-and-AI/Data/Model/ModelData.csv")
...
#A partir de aqu? se mete los regresores
ids<-c("iso_code3","country")
response<-"EN.ATM.CO2E.PC"
predictors<-c("a_environment","a_urban","a_social_development", "a_transport" ,"a_health","a_energy","NY.GNP.PCAP.CD","SI.DST.FRST.20","DT.ODA.ODAT.PC.ZS")
length(predictors)
predictors
c(response, predictors) %in% colnames(data)
